...
{ 
	...
	{ 
		...
		{ 
			...
			// print cart;
			/*
			 * double totalprice = 0; for (int i = 0; i < shoppingTest.itemCount; i++) {
			 * item = shoppingTest.cart[i]; System.out.println(item.getName() + ":  " +
			 * item.getQuantity() + "*" + item.getPrice()); totalprice += item.getQuantity()
			 * * item.getPrice(); } System.out.println("Total price: " + totalprice);
			 */
